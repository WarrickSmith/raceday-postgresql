...
**T2 - Progressive Data Loading Strategy Complete:**
...
- `/client/src/app/api/race/[id]/entrants/route.ts` - API endpoint for entrants data (target: 100ms)
- `/client/src/app/api/race/[id]/navigation/route.ts` - API endpoint for navigation data (target: 150ms)  
- `/client/src/app/api/race/[id]/historical/route.ts` - API endpoint for historical data (background loading)
