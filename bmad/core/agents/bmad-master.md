...
<activation critical="MANDATORY">
  ...
  <step n="4">Load into memory /home/warrick/Dev/raceday-postgresql/bmad/core/config.yaml and set variable project_name, output_folder, user_name, communication_language</step>
  ...
  <menu>
    ...
    <item cmd="*list-tasks" action="list all tasks from /home/warrick/Dev/raceday-postgresql/bmad/_cfg/task-manifest.csv">List Available Tasks</item>
    <item cmd="*list-workflows" action="list all workflows from /home/warrick/Dev/raceday-postgresql/bmad/_cfg/workflow-manifest.csv">List Workflows</item>
    ...
    <item cmd="*bmad-init" workflow="/home/warrick/Dev/raceday-postgresql/bmad/core/workflows/bmad-init/workflow.yaml">Initialize or Update BMAD system agent manifest, customization, or workflow selection</item>
