...
<task id="bmad/bmm/tasks/daily-standup.md" name="Daily Standup">
  ...
  <flow>
    <step n="1" title="Project Context Discovery">
      <action>Check for stories folder at /home/warrick/Dev/raceday-postgresql{output_folder}/stories/ directory</action>
...
{{ List Agents from /home/warrick/Dev/raceday-postgresql/bmad/_cfg/agent-party.xml }}
      </output>
    </step>
...
Need extended discussion? Use *party-mode for detailed breakout.
  ...
  <activation critical="MANDATORY">
    <init>
      ...
      <step n="2">Override with /home/warrick/Dev/raceday-postgresql/bmad/_cfg/agents/bmm-daily-standup.md if exists (replace, not merge)</step>
    ...
    <commands critical="MANDATORY">
      ...
      <handlers>
        ...
        <handler type="validate-workflow">
          ...
          1. You MUST LOAD the file at: /home/warrick/Dev/raceday-postgresql/bmad/core/tasks/validate-workflow.md
