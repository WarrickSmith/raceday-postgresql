/**
 * Logging Utilities for Master Race Scheduler Function
...
/**
 * Log essential performance metrics (always logged unless SILENT)
 * @param {Object} context - Appwrite function context
 * @param {string} operation - Operation name
 * @param {number} startTime - Start time in milliseconds
 * @param {Object} metrics - Additional metrics to log
 */
export function logPerformance(context, operation, startTime, metrics = {}) {
    if (isLogLevelEnabled('ERROR')) {
        const duration = Date.now() - startTime;
        context.log(`[PERF] ${operation}`, {
            durationMs: duration,
            ...metrics,
